...
const CreateProfileCryptoInformation = (props: Props) => {
    ...
    return (
        <SafeAreaView style={[styles.container, {
            ...
            <View>
                <DropDownInput
                    inputTitle={userType != 1 ? "Kripto Para Bilgisi" : "Kripto Para Tecrübeniz"}
...

                {
                    ...
                    <View>
                        <DropDownInput
                            ...
                            data={["0-100", "100-300", "300-1000", "1000-2000", "2000 ve üzeri", "Yok"]}
                            placeHolder='3-6 Ay'
                            // value={values.namesurname}
                            // onChange={(text) => setValues({ ...values, namesurname: text })}
                            onSelectionChange={() => {
                ...
                <Button
                    onPress={() => { GoToCreateProfileFinish({ userType: userType }) }}
                    text='İlerle'
                    // disabled={true}
                    style={{
                        marginTop: hp('3%'),
